...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#FCFBF9] text-[#121212] font-sans selection:bg-[#F2C94C]/30">
      
      {/* NAVBAR */}
      <header className="w-full bg-[#FCFBF9] sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 h-20 grid grid-cols-3 items-center">
          ...
          <nav className="hidden md:flex justify-center gap-8 text-xs font-bold text-[#5E5E5E]">
            ...
            <Link href="#planos" className="hover:text-[#121212] transition-colors">Preços/Planos</Link>
      ...
      <main>
        {/* HERO SECTION */}
        <section className="relative max-w-4xl mx-auto px-6 pt-24 pb-32 flex flex-col items-center text-center overflow-hidden">
          {/* Glow de fundo */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#F2C94C]/10 blur-[100px] rounded-full -z-10 pointer-events-none" />

          <h1 className="text-5xl md:text-[56px] font-black tracking-tight leading-[1.1] mb-6 text-[#121212]">
            Tudo o que você precisa<br />
            para <span className="bg-[#F2C94C] px-2 rounded-md inline-block transform -rotate-1">gerenciar tarefas</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 mb-10">
            ...
            <Link href="#planos">
              <Button variant="outline" className="px-8 py-3.5 text-sm font-bold border border-[#EAEAEA] hover:bg-[#F9F7F5] text-[#121212] rounded transition-colors bg-white shadow-sm">
                Conhecer Planos
              </Button>
            </Link>
          </div>
          ...
          <div className="inline-flex items-center gap-2 px-5 py-2 border border-[#EAEAEA] rounded-full text-xs font-medium text-[#5E5E5E] bg-white shadow-sm">
        ...
        <section id="funcionalidades" className="max-w-5xl mx-auto px-6 py-20">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="w-full bg-white rounded-xl p-6 shadow-[0_10px_40px_rgba(0,0,0,0.08)] border border-[#F4F1ED] relative overflow-hidden h-[300px] flex flex-col gap-4 justify-center">
              {/* Item 1 - Prioridade */}
              <div className="flex items-center justify-between border border-[#F4F1ED] p-3 rounded-lg shadow-sm bg-white relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-2 md:order-1">
              ...
              <Link href="/dashboard" className="inline-flex items-center gap-2 text-xs font-bold text-[#8A6727] hover:opacity-70 transition-opacity">
                Explorar Painel <span className="font-normal">→</span>
              </Link>
            </div>

            {/* Gráfico (agora na direita) */}
            <div className="order-1 md:order-2 w-full bg-white rounded-xl p-8 flex flex-col justify-end shadow-[0_10px_40px_rgba(0,0,0,0.08)] border border-[#F4F1ED] relative h-[320px]">
              
              {/* Barras */}
              <div className="flex items-end justify-between gap-2 h-full border-b-2 border-[#EAEAEA] pb-4 mb-4">
                <div className="w-full bg-[#EAEAEA] h-[25%] rounded-t-sm" />
                <div className="w-full bg-[#F2C94C] h-[50%] rounded-t-sm" />
                <div className="w-full bg-[#EAEAEA] h-[35%] rounded-t-sm" />
                <div className="w-full bg-[#121212] h-[75%] rounded-t-sm" />
                <div className="w-full bg-[#F2C94C] h-[45%] rounded-t-sm" />
              </div>
      ...
      {/* FOOTER */}
      <footer className="border-t border-[#EAEAEA] bg-white pt-16 pb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-8">
            ...
            <div className="col-span-1">
              ...
              <ul className="space-y-3 text-xs font-bold text-[#5E5E5E]">
                ...
                <li><Link href="#planos" className="hover:text-[#121212] transition-colors">Preços/Planos</Link></li>
            ...
            <div className="col-span-1 flex flex-col items-end text-right justify-between h-full">
              ...
              <div className="flex gap-4 text-[9px] font-black tracking-widest uppercase text-[#5E5E5E] mt-4">
                <Link href="/contato" className="hover:text-[#121212]">CONTATO</Link>
                <Link href="/suporte" className="hover:text-[#121212]">SUPORTE</Link>
              </div>
            </div>
          </div>
        </div>
